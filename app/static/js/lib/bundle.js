...
/***/ function(module, exports, __webpack_require__) {
	...
	var Container = __webpack_require__(148);
	
	React.render(React.createElement(Container, null), document.getElementById("message-board-container"));
			...
			return(
				...
				React.createElement("h4", null, " Leave a Message "), 
					React.createElement("div", {className: "form-group"}, 
						React.createElement("label", {for: "exampleinputemail1"}, "your name"), 
						React.createElement("input", {ref: "name", className: "form-control", placeholder: "your name"})
					), 
					React.createElement("div", {className: "form-group"}, 
						React.createElement("label", {for: "exampleinputemail1"}, "your comment"), 
						React.createElement("textarea", {ref: "comment", className: "form-control", placeholder: "enter message"})
	                ), 
	                React.createElement("a", {onClick: this.onSubmit, className: "btn btn-primary"}, "submit")
	            )
		...
		render: function() {
			var message = this.props.data.map(function(item){
				return (
					...
					React.createElement("p", null, " ", item.comment, " ")
					)
				)
			});
			return(
				React.createElement("ul", {className: "list-group", id: "message-container"}, 
				React.createElement("li", {className: "list-group-item"}, "Placeholder message"), 
				message
				)
			)
		}
